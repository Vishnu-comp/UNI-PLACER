...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo web_root;?>/admin/" class="logo">
      ...
      <span class="logo-mini"><b>UniPlacer</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>UniPlacer</b></span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu"> 
       ...
       <!--  <li class="treeview">
        ...
        <li>
    <a href="http://localhost:8080/eris/index.php?q=register">
        <i class="fa fa-user"></i> <span>Register Students</span> 
    </a>
</li>
